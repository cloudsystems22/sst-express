...
perigos_ges.findAll({ where:{ setores_id: [69] }, attributes:['setores_id'], group:['tipo'], include:[{model:agentes_riscos, as:'agentes_riscos', attributes:['tipo']}]}).then(
    data => {
...
//         lista.forEach(array =>{
//             riscos.push({tipo:array.agentes_riscos.tipo, risco:array.agentes_riscos.risco})
//         })
